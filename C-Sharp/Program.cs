namespace C_Sharp
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            int answer = opdracht_2_17(4, 3, 6, 1);
            Console.WriteLine("Sum: " + answer);

            opdracht_2_21(5);
        }

        static void opdracht_1_10()
        {
            //Opdracht 1-10
        ...
        public static void opdracht_2_11(int number)
        {
            //Opdracht 2-11
        ...
        public static int opdracht_2_17(int number1, int number2, int number3, int number4)
        {
            //Opdracht 2-17
        ...
        public static void opdracht_2_20(int number)
        {
            //Opdracht 2-20
            for (int i = 0; i < number; i++)
            {
        ...
        public static void opdracht_2_21(int size)
        {
            PrintTriangle(size);
        }
